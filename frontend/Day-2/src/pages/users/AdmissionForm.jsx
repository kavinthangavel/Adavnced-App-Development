  ...
  return (
    <div className="admission-form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label htmlFor="howDidYouKnow">How did you come to know about Amrita? *</label>
        <select id="howDidYouKnow" value={howDidYouKnow} onChange={(e) => setHowDidYouKnow(e.target.value)} required>
          <option value="">--Select--</option>
          {/* Add options for how they came to know about Amrita */}
        </select>
        ...
        <Link to="/pay" className="border border-blue-500 hover:bg-blue-500 hover:text-white px-8 py-4 rounded-lg text-lg font-semibold">Pay Now</Link>
      </form>
    </div>
  );
};
